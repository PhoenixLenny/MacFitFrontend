...
<template>
  <v-container style="background-color: #E3F2FD" max-width="100%">
    ...
    <v-row>
      <v-col md="3">
        <v-card class="text-center" @click="showBundle('Daily Pass', '500 Ksh')">
      ...
      <v-col md="3">
        <v-card class="text-center" @click="showBundle('Monthly Pass', '5,000 Ksh')">
      ...
      <v-col md="3">
        <v-card class="text-center" @click="showBundle('3-month Pass', '12,000 Ksh')">
      ...
      <v-col md="3">
        <v-card class="text-center" @click="showBundle('6-Month Pass', '20,000 Ksh')">
    ...
    <v-row>
      <v-col md="3">
        <v-card class="text-center" hover>
          ...
          <v-card-text>
            Can’t make it to the floor? Take our expert-led classes with you via our digital library,
            featuring live streams and habit-tracking tools.
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col md="3">
        <v-card class="text-center" hover>
          ...
          <v-card-text>
            Master your diet with custom macro-calculations and exclusive discounts on premium meal-prep
            and our in-house fuel bar.
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col md="3">
        <v-card class="text-center" hover>
          ...
          <v-card-text>
            Access professional-grade tools like infrared saunas, cold plunges, and percussion therapy to
            slash your soreness and bounce back faster.
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col md="3">
        <v-card class="text-center" hover>
          ...
          <v-card-text>
            Go beyond the scale with 3D body scanning and quarterly consultations. We map your progress so
            you know exactly how your body is changing.
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
  ...
  <v-container style="background-color: #E3F2FD" max-width="100%" class="mt-12">
    ...
    <v-row>
      <v-list>
        <v-list-item>1. Select your preferred gym</v-list-item>
  ...
  <v-dialog v-model="showBundleDialog" max-width="600">
    <v-card prepend-icon="mdi-account" title="Subscribe to Bundle">
      <v-card-text>
        You are about to subscribe to {{ selectedBundle }} at {{ selectedPrice }}. Click on the button below
        to complete payment.
      </v-card-text>
